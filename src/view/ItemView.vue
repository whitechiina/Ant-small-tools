  ...
  <div>
    ...
    <div class="container">
      <div class="item" v-for="(item, index) in data" :key="index">
        <div class="item-pic">
          <svg t="1606271416763" class="icon" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg"
            p-id="2290" width="200" height="200">
            <path
